...
print("Welcome to the simplified business proposal summary task. I'll guide you through 5 easy steps. Let's start with Step 1: Project title. Please provide a title for your project in this format: [Project Name]: [Brief Description]. For example, 'EcoPackage: Biodegradable Packaging Solutions'")
